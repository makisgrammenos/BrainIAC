...
from adni_dataset import ADNIDataset, get_validation_transform
...
def main():
    ...
    parser.add_argument('--nifti_col', type=str, default='nifti_path',
                      help='Column name in CSV for nifti image paths (default: nifti_path)')
    parser.add_argument('--label_col', type=str, default='label',
                      help='Column name in CSV for class labels (default: label)')
